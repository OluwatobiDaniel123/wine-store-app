...
const Product = (props) => {
  ...
  return (
    <div className="w-88 h-72 bg-[#d7d7fa] rounded-lg relative group shadow-lg">
      <div className="max-w-80 max-h-60 relative overflow-y-hidden ">
        <div onClick={handleProductDetails}>
          <Image className="w-full h-52 bg-white" imgSrc={props.img} />
        </div>
      ...
      <div className="max-w-80 py-2 flex flex-col gap-1 border-[1px] border-t-0 px-2">
        <div className="flex items-center justify-between font-titleFont">
          <h2 className="text-primeColor font-bold text-xs">
            {props.productName}
          </h2>
